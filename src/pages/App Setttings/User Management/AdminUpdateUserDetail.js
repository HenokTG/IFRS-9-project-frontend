...
export default function AdminUpdateUserDetail() {
  ...
  // Module snipts to update user detail copied from Tabor Remit Project
  // const { userID } = useParams();
  // .put(`api/agent/profiles/${userID.split('=')[1]}/`, postData)
